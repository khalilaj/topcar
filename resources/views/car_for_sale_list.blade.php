      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="/car_for_sale" title="">Cars For Sale</a> <span>&rsaquo; </span> </li>  
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
          ...
          <div class="category-products">
            <ul class="products-grid">
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                ...
                <div class="item-img">
                  <div class="item-img-info"><a href="car_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="{{ asset('uploads/car_for_sale/'.$car_for_sale->image) }}" alt="Retis lapen casen"></a>
                  ...
                  <div class="info-inner">
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <div class="price-box"><span class="regular-price"><span class="price"> KSH {{ $car_for_sale->price }}</span> </span> </div>
                      </div>
