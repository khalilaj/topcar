              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                    ...
                    <div class="product-image">
                      <div class="product-full"> <img id="product-zoom" src="frontend/products-images/p35.jpg" data-zoom-image="frontend/products-images/p35.jpg" alt="product-image"/> </div>
                      <div class="more-views">
                        <div class="slider-items-products">
                          <div id="gallery_01" class="product-flexslider hidden-buttons product-img-thumb">
                            <div class="slider-items slider-width-col4 block-content">
                              <div class="more-views-items"> <a href="#" data-image="frontend/products-images/p36.jpg" data-zoom-image="frontend/products-images/p36.jpg"> <img id="product-zoom0"  src="frontend/products-images/p36.jpg" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="frontend/products-images/p45.jpg" data-zoom-image="frontend/products-images/p45.jpg"> <img id="product-zoom1"  src="frontend/products-images/p45.jpg" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="frontend/products-images/p42.jpg" data-zoom-image="frontend/products-images/p42.jpg"> <img id="product-zoom2"  src="frontend/products-images/p42.jpg" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="frontend/products-images/p33.jpg" data-zoom-image="frontend/products-images/p33.jpg"> <img id="product-zoom3"  src="frontend/products-images/p33.jpg" alt="product-image"/> </a> </div>
                              <div class="more-views-items"> <a href="#" data-image="frontend/products-images/p38.jpg" data-zoom-image="frontend/products-images/p38.jpg"> <img id="product-zoom4"  src="frontend/products-images/p38.jpg" alt="product-image" /> </a></div>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="product-shop col-lg- col-sm-7 col-xs-12">
                    ...
                    <div class="price-block">
                      <div class="price-box"> 
                        <p class="special-price"> <span class="price-label">Special Price</span> <span id="product-price-48" class="price"> KSH 309 99 </span> </p>
