      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="/spareparts_for_sale" title="">Find Spare Parts</a> <span>&rsaquo; </span> </li>  
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
            ...
            <ul class="products-grid">
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
               <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p31.jpg" alt="Retis lapen casen"></a>
                    <div class="new-label new-top-left">Used</div> 
                  </div>
                </div>
                <div class="item-info">
                  <div class="info-inner">
                    <div class="item-title"><a href="spareparts_for_sale_detail" title="Retis lapen casen">Gorgeous Mercedes-Benz E-Class All-Terrain Luxury</a> </div>
                    <div class="item-content">
                    
                      <div class="item-price">
                        <div class="price-box"><span class="regular-price"><span class="price">KHS 4900</span> </span> </div>
                      </div>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p32.jpg" alt="Retis lapen casen"></a>
                ...
                <div class="item-info">
                  <div class="info-inner">
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <div class="price-box"><span class="regular-price"><span class="price">KH 49000</span> </span> </div>
                      </div>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p33.jpg" alt="Retis lapen casen"></a>
                  
                  </div>
                </div>
                <div class="item-info">
                  <div class="info-inner">
                    <div class="item-title"><a href="car-detail.html" title="Retis lapen casen">Gorgeous Mercedes-Benz E-Class All-Terrain Luxury</a> </div>
                    <div class="item-content">
                  
                      <div class="item-price">
                        <div class="price-box"><span class="regular-price"><span class="price">KSH 500</span> </span> </div>
                      </div>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p35.jpg" alt="Retis lapen casen"></a>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p38.jpg" alt="Retis lapen casen"></a>
              ...
              <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info"><a href="/spareparts_for_sale_detail" title="Retis lapen casen" class="product-image"><img src="frontend/products-images/p39.jpg" alt="Retis lapen casen"></a>
