                  ...
                  <nav>
                    ...
                    <div class="nav-inner">
                      ...
                      <ul id="nav" class="hidden-xs">
                        ...
                        <li class="level0 parent drop-menu"> <a class="level-top" href="list.html"><span>Car
                              Listing‎</span></a>
                        </li>
                        <li class="level0 parent drop-menu"> <a class="level-top" href="blog.html"><span>Blog</span></a>
                        ...
                        <li class="mega-menu hidden-sm"> <a class="level-top"
                            href="/register"><span>Register‎</span></a> </li>
                      </ul>
                      <!--nav-->
                    </div>
                  </nav>
            ...
            <div class="slider-items slider-width-col4 products-grid">
              ...
              <div class="item">
                <div class="item-inner">
                  <div class="item-img">
                    <ul class="item-img-info"><a href="car-detail.html" title="Retis lapen casen"
                        class="product-image">
                        @foreach($car_for_sales as $car_for_sale)
                            <div class="pro-img"><img src="{{ asset('uploads/car_for_sale/'.$car_for_sale->image) }}">
                      ...
                      <div class="sale-label sale-top-left">-{{ $car_for_sale->discount }}%</div>
                    
                  
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"><a href="car-detail.html" title="Retis lapen casen">{{ $car_for_sale->name }}</a> </div>
